...
public class ArrayList {
    ...
    public ArrayList () {
        ...
        // => 생성자를 호출 할수 있는 경우
        //    1) new 명령을 사용할 때
        //    2) 생성자에서 다른 생성자를 호출 할때
        //    그외에는 임의로 생성자를 호출할수 없다.
        // 일반 메서드에서 생성자를 임으로 호출할수 없다.
        // 다른 생성자를 호출할 때는 super 클래스의 생성자를 호출 할수 없다.
        // => 둘중 하나만 첫 문장으로 올수 있다.
        //super(); // 컴파일 오류!
        this(DEFAULT_CAPACITY);
    }
    public ArrayList(int capacity) {
        // super(); 항상 생성자에는 수퍼 클래스의 기본 생성자를 호출하는 문장이 숨겨져있다.
        //          물론 개발자가  수퍼 클래스의 생성자를 호풀 하겠다소 명시한다면 당연히 자동으로 붙지않는다.
