...
public class Exam01_6 {
    ...
    static class Member {
        ...
        // => 만약 값을 저장하는 것이아닌 조회하는 용도로만 사용하는 변수하면
        //    대문자로 선언하여 상수임을 표현하라!
        // => 조회 용도로만 사용하기로 했으면 문법덕으로 값을 변경하는 것을 막아라!
        // => 보통 조회용으로 사용하는 변수는 공개해도 되기 떄문에 public
        final static int GUEST = 0;
        final static int MEMBER = 1;
        final static int MANGER = 2;
    ...
    public static void main(String[] args) {
        ...
        // 소스 코드를 작성한 사람도 숫자의 의미를 기억하기 쉽지 않는데,
        // 남의 소스 코드를 우지 보수하는 사람은 더더욱 숫자의 의미를 파악하기 어렵다.
        // 주석이나 개발 문서를 자세히 살펴 보지 않는 이상에는 숫자의 의미를 파악하기 쉽지 않다.
        //
        // "이런 경우를 방지하고자 나온 문법이 상수이다."
        // => 즉 의미있는 이름으로 변수를 만들어 놓고 그 변수에 숫자를 저장한다.
        // => 그리고 그 값을 사용할 때는 변수를 통해서 
