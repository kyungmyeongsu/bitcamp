...
public class Exam02_1 extends C{
    ...
    public static void main(String[] args) {
        ...
        //obj1.privateVar = 100; // 접근 불가! 오직 그 클래스안에서만 사용가능.
...
// => 겟터, 셋터는 public으로 접근을 모두에세 공개한다.
// => 일반 메서드도 public으로 접근을 모두에게 공개한다
// => 그 클래스 내부에서만 사용돠는 메서드는 private으로 접근을 제한한다.
// => 자식 클래스의 접근을 허용할 필요가 있을 겅우에만 protected 로만든다.
// => 다른 개발자가 사용할 클래스 모음을 만들 때
//    그 모음집 내에서만 사용될 변수나 메서드인 경우 (default)로 접근을 제한한다.
//    즉 라이브러리를 만드는 개발자인 경ㅇ (default)를사용하는 경우가 있다.