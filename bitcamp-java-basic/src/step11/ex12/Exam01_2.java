...
public class Exam01_2 {
    ...
    static class Score {
        ...
        // Object로부터 상속받은 toString() 리턴 값이 마음에 들지 않는다면 재정의하라!
        // => 보통 인스턴스의 내부 데이터를 문자열로 리턴하도록 변경한다.
        // => 프로그램을 샐행하는 중에 인스턴스의 내부 값을 빠르게 확인 하고 싶을 때
        //    개발자들이 종종
        @Override
    ...
    public static void main(String[] args) {
        ...
        // println()에 String이아닌 객체를 넘기면,
        // println()에서 내부적으로 그 객체에 대해 toString()을 호출하여
        // 그 리턴 값을 출력한다.
        // 따라서, 다음 코드는 위의 코드와 같은 결과를 출력한다.
        System.out.println(s1);
        // 그러니 println()으로 객체의 값을 출력할 때 굳이 toString()을 번거롭게 호출하지마라!
