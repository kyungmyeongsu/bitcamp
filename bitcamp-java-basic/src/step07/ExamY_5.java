...
public class ExamY_5 {
    public static void main(String[] args) {
        ...
        // 그렇다면 개별저을 관리할 변수를 인스턴스변수로 선언하라!
        ...
        // 계산을 수행 할떄 계산 결과를 보관할 메모리를 전달하라!
        // => 인스턴스 메서드를 사용하면 파라미터로 메모리 주소를 전달 할 필요가 없다.
        c1.plus(2);
        c2.plus(3);
        ...
        // 식1의 계산 결과는 c1 인스턴스에 result에 들어있고,
        // 식2의 계산 결과는 c2 인스턴스에 result에 들어있다.
