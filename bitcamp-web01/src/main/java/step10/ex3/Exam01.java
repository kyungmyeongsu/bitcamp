...
public class Exam01 extends HttpServlet {
    ...
    protected void doGet(
        ...
        //    즉 문자열외에 숫자, 객체 모두 저장할 수 있다.
        session.setAttribute("s1", "aaa");
        session.setAttribute("s2", 200); // auto-boxing을 수행하여 객체로 변환한후 저장된다.
...
// 세션 생성: getSession() 호출
// - 우선 웹브라우저가 보낸 쿠키 중에서 세션아이디가 있는지 확인한다.
// - 만약 없다면 새 세션 객체(HttpSession)를 생성한 후 그 세션 객체를 리턴한다.
// - 응답할 때 새로 생성한 세션 객체의 아이디를 웹브라우저로 쿠키에 담아 전달한다.
//        
// Http 응답 프로토콜 예:
//        HTTP/1.1 200
//        Set-Cookie: JSESSIONID=0358E9C46754BA8C2D7A3C9898C73902; Path=/bitcamp-web01; HttpOnly
//        Content-Type: text/plain;charset=UTF-8
//        Content-Length: 119
//        Date: Wed, 23 May 2018 05:22:55 GMT
    }
}
