...
ServletCotext ==> applicationScope(EL), application(JSP)
</pre>
<%
...
SerletContext: ${applicationScope.name} <br>
SerletContext: <%=application.getAttribute("name")%> <br>
...
- 위와 같은 이유료, getAttribute()를 호출하는 EL표기법을 만들기 위해 xxxScope이라는 이름을 만든 것이다.
