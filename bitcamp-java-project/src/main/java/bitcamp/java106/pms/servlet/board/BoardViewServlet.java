...
public class BoardViewServlet extends HttpServlet {
    ...
    protected void doGet(
        ...
        try {
            ...
            out.printf("<input type='text' name='no' value='%d' readonly></td></tr>", board.getNo());
            out.println("<tr><th>제목</th><td>");
            out.printf("<input type='text' name='title' value='%s'></td></tr>", board.getTitle());
            out.println("<tr><th>내용</th><td>");
            out.printf("<textarea name='content' rows='10' cols='60'>%s</textarea></td></tr>", board.getContent());
