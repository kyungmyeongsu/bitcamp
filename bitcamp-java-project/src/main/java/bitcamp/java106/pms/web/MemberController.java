...
//ver 22 - MemberService 변경 사항에 맞춰 이 클래스를 변경한다.
//ver 18 - ArrayList가 적용된 MemberService를 사용한다.
//         onMemberList()에서 배열의 각 항목에 대해 null 값을 검사하는 부분을 제거한다.
//ver 16 - 인스턴스 변수를 직접 사용하는 대신 겟터, 셋터 사용.
// ver 15 - MemberService를 생성자에서 주입 받도록 변경.
// ver 14 - MemberService를 사용하여 회원 데이터를 관리한다.
